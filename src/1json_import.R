...
# Import all the raw json data files
...
jsonRaw4_1_1 <- fromJSON(file = "json_data/Test4-1-1.json")
jsonRaw4_1_2 <- fromJSON(file = "json_data/Test4-1-2.json")
jsonRaw4_1_3 <- fromJSON(file = "json_data/Test4-1-3.json")